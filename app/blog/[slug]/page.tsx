    ...
    <main className="min-h-screen bg-background">
      ...
      <article className="px-6 py-12 md:py-16">
        <div className="mx-auto max-w-3xl">
          ...
          {/* Title */}
          <h1
            className="text-display text-3xl sm:text-4xl md:text-5xl text-foreground mb-8 animate-fade-up"
          ...
          {post.coverSrc && (
            <div
              className="relative aspect-[16/9] overflow-hidden rounded-lg bg-muted mb-12 animate-fade-up"
  ...
  return (
    <article className="group animate-fade-up opacity-0" style={{ animationDelay: `${0.1 + index * 0.05}s` }}>
      <Link href={`/blog/${post.slug}`} className="block">
        <div className="relative aspect-[16/9] overflow-hidden rounded-lg bg-muted mb-4 image-zoom">
          {post.coverSrc ? (
            <Image
              src={post.coverSrc}
              alt={post.title}
